package com.group20.dailyreadingtracker.utils;
...
/**
 * Service for sending email communications including verification and password reset emails.
 * 
 * Features:
 * - Sends HTML-formatted emails
 * - Handles verification emails for new registrations
 * - Processes password reset requests
 * - Includes proper email headers and sender information
 * 
 * Configuration:
 * - Uses JavaMailSender for email transport
 * - Sender email and name are configurable through properties
 * 
